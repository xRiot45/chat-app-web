...
interface ChatMessageListProps {
    messages: Message[];
    currentUserId: string; // PENTING: Untuk cek isMe
    messagesEndRef: React.RefObject<HTMLDivElement>;
}

export function ChatMessageList({ messages, currentUserId, messagesEndRef }: ChatMessageListProps) {
    return (
        <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 custom-scrollbar scroll-smooth">
            {/* Date Divider (Logic sederhana) */}
