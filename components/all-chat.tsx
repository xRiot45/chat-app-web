...
interface AllChatProps {
    ...
    selectedChat: IAllChat | null;
}

export default function AllChat({ handleChatSelect, selectedChat }: AllChatProps) {
    return (
        <div>
                ...
                {ALL_CHATS.map((chat) => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            >
                                {chat.type === "group" && (
                                    <span className="font-bold text-indigo-400 mr-1">Sarah:</span>
                                )}
                                {chat.lastMsg}
                            </p>
                        </div>
